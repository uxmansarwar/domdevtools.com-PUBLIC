<div class="row">
        ...
        <div class="row">
            <div class="col-12">
                <div class="position-relative">
                    <label class="input_text_label" for="input_text ">Domain Name</label>
                    <textarea id="input_text" rows="8" class="form-control text_border_etc" placeholder="Insert Your Domains here"></textarea>
                </div>
            </div>
        </div>
    </div>
    <div class="col-12">
        ...
        <div id="action_btn" class="site-color mt-2 btn rounded-0 pointer">
            Generator Expected Email Address
        </div>



        <div id="upload_file" class="bg-info text-white mt-2 btn rounded-0 pointer">
            <i class="pointer icon icon-upload icon-white mb-1"></i> Upload Domains File
        </div>
