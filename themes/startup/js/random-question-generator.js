...
_$.onDOMReady(_ => {
    ...
    let _c = _$.elemSelector(['#tool_form', '#number_of_questions', '#action_btn']);
    ...
    _c.tool_form.addEventListener('submit', _ => {
        ...
        number_of_questions = parseInt(_c.number_of_questions.value.trim() || number_of_questions);



        if (parseInt(number_of_questions) > 0) {

            displayResultItems(questions);
        }
